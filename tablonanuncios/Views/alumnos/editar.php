                ...
                <div class="col-xs-12 col-sm-10 col-sm-offset-1" style="border: 1px solid #E1E1E1;">
                    <form action="" class="form-horizontal" id="formAnuncio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">                       
                                <input type="datetime-local" class="form-control" id="fechaPublicado" name="fechaEditarPublicado" placeholder="" readonly="true">
                               <span class="help-block"></span>       
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">                       
                                <input type="datetime-local" class="form-control" id="fechaPublicacion" name="fechaEditarPublicacion" placeholder="fecha">
                              <span class="help-block"></span>       
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="grup-pdf" >
                        ...
                        <div class="form-group  col-xs-12 bloque-btn"> 
                            <!--<div class="form-group">-->
                                <!--<p class="text-center">-->
                                    <button type="button" class="btn btn-primary" id="botonEnviar">Actualizar
