    ...
    if (resultado['registros']) {
        ...
        $.each(resultado['registros'], function (pos, obj) {
            ...
            $("#listar").append("<tr><td value='titulo'>" + pos + "</td>" +
                    ...
                    "<td><a class='btn btn-danger btn-xs' data-title='Delete' data-toggle='modal' data-target='#delete'  value=" + obj[0] + "><span class='glyphicon glyphicon-trash'></span></a></td>");
