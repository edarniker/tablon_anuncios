...
//    $("#file").on("change", subirFile);
    $("#borrarImg").on("click", borrarImagenes);
    $("#borrarPdf").on("click", borrarPdf);
...
//           alert(obj[pos].name);
        ...
        if (obj.size > 1024 * 1024) {
            $("#parrafo-img").html("<p style='color:red'> el archivo " + obj.name + " supera el maximo permitido 1MB</p>");
...
function editarArchivos(categoria) {
    var formData = new FormData($("#formAnuncio").get(0));
    formData.append("categoria", categoria);   
    enviarDatoFichero("../ajax", "POST", formData, "text", "editar_ficheros");
}
