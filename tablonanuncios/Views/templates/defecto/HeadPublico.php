    ...
    public static function pintar($templateParams, $templateParamsP, $titulo) {
        ...
        <html>
            <head>  
                ...
                <!--<link href="<?php echo $templateParamsP['ruta_css'] ?>style2.css" rel="stylesheet" type="text/css" media="all" />--> 
                <!--<link href="<?php echo $templateParamsP['ruta_css'] ?>style4.css" rel="stylesheet" type="text/css" media="all" />--> 
               ...
               <script defer src="<?php echo $templateParamsP['ruta_js'] ?>bootstrap.js"  type="text/javascript"></script>   
                <script defer src="<?php echo $templateParams['ruta_js'] ?>ajaxPublico.js"  type="text/javascript"></script>            
